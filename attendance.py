...
#variable
        ...
        img1 = img1.resize((900,100),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        label1 = Label(self.root,image=self.photoimg1)
        label1.place(x=0,y=0,width=900,height=100)

        img2 = Image.open("college_images\Ab.jpeg")
        img2 = img2.resize((900,100),Image.ANTIALIAS)
        self.photoimg2=ImageTk.PhotoImage(img2)

        label2 = Label(self.root,image=self.photoimg2)
        label2.place(x=900,y=0,width=900,height=100)

#label
        title_lbl=Label(self.root,text="Attendance",font=("times new roman",35,"bold"),bg="white",fg="black")
        title_lbl.place(x=0,y=100,width=1000,height=50)
        
        main_frame=Frame(self.root,bd=2)
        main_frame.place(x=0,y=100,width=1000,height=700)
...
#class student info
        ...
        class_student_frame.place(x=10,y=20,width=700,height=400)

#Attendance_id
        Attendanceid_label=Label(class_student_frame,text='AttendanceId:',font=("times new roman",12,"bold"),bg="white")
...
#status
        Status_label=Label(class_student_frame,text='Attendance Status',font=("times new roman",12,"bold"),bg="white")
...
#bbuttons frame
        ...
        update_btn=Button(btn_frame,text="Update",width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
...
#right label frame
        ...
        right_frame.place(x=750,y=10,width=1800,height=700)
        
        table_frame=Frame(right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=1800,height=600)
