...
class Face_recognition:
    def __init__(self,root):
        ...
        img_left = img_left.resize((500,700),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        label1 = Label(self.root,image=self.photoimg_left)
        label1.place(x=0,y=45,width=500,height=700)
        ...
        img_right = img_right.resize((500,700),Image.ANTIALIAS)
        self.photoimg_right=ImageTk.PhotoImage(img_right)

        label2 = Label(self.root,image=self.photoimg_right)
        label2.place(x=500,y=45,width=500,height=700)

        b2=Button(label2,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("time new roman",20,"bold"),bg="blue",fg="white")
        b2.place(x=120,y=500,width=250,height=50)
