...
#background image
        backimg = Image.open("college_images\gsp.jpg")
...
#label
        title_lbl=Label(label3,text="Student Management System",font=("times new roman",35,"bold"),bg="white",fg="black")
...
#current course
        left_frame2 = LabelFrame(left_frame,bd=2,relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        left_frame2.place(x=10,y=50,width=700,height=120)
    #Department   
        dep_label=Label(left_frame2,text='Department',font=("times new roman",12,"bold"),bg="white")
    ...
    #Course
        course_label=Label(left_frame2,text='Course',font=("time new roman",12,"bold"),bg="white")
        course_label.grid(row=0,column=2,padx=10)

        course_combo=ttk.Combobox(left_frame2,textvariable=self.var_course,font=("time new roman",12,"bold"),width=17,state="read only")
        course_combo["values"]=("select Course","SE","FE","BE","TE","SE")
...
#class student info
        ...
        class_student_frame.place(x=10,y=225,width=850,height=300)
#id
...
#class
        studentclass_label=Label(class_student_frame,text='Class Division:',font=("times new roman",12,"bold"),bg="white")
        studentclass_label.grid(row=1,column=0,padx=10,pady=5,sticky=W)

        class_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",12,"bold"),width=17,state="read only")
        class_combo["values"]=("select Division","a","b","c")
        class_combo.current(0)
        class_combo.grid(row=1,column=1,padx=10,pady=5,sticky=W)
       
#roll
        studentroll_label=Label(class_student_frame,text='Roll No:',font=("times new roman",12,"bold"),bg="white")
...
#phone
        studentphone_label=Label(class_student_frame,text='Phone:',font=("times new roman",12,"bold"),bg="white")
...
#teacher
        studentteacher_label=Label(class_student_frame,text='Teacher Name:',font=("times new roman",12,"bold"),bg="white")
...
#buttons frame
        ...
        save_btn=Button(btn_frame,text="save",command=self.add_data,width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        save_btn.grid(row=0,column=0)
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        update_btn.grid(row=0,column=1)
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        delete_btn.grid(row=0,column=2)
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        reset_btn.grid(row=0,column=3)

        take_photo_btn=Button(btn_frame,text="Take Photo",command=self.generate_dataset,width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        take_photo_btn.grid(row=1,column=0)
        update_photo_btn=Button(btn_frame,text="Update Photo",width=15,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        update_photo_btn.grid(row=1,column=1)

        btn_frame2=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame2.place(x=0,y=240,width=700,height=35)
        take_photo_btn=Button(btn_frame2,text="Take Photo Sample",command=self.generate_dataset,width=30,font=("time new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        take_photo_btn.grid(row=1,column=0)
        update_photo_btn=Button(btn_frame2,text="Reset Photo Sample",width=30,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        update_photo_btn.grid(row=1,column=1)
...
#=======Search System==========#
        ...
        search_student_frame.place(x=10,y=50,width=850,height=70)

        search_label=Label(search_student_frame,text='Search By:',font=("times new roman",15,"bold"),bg="white")
        search_label.grid(row=0,column=0,padx=10,sticky=W)

        search_combo=ttk.Combobox(search_student_frame,font=("times new roman",12,"bold"),width=8,state="read only")
        search_combo["values"]=("select","Roll No","Phone_No")
        search_combo.current(0)
        search_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)

        search_entry=ttk.Entry(search_student_frame,width=5,font=("times new roman",13,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        search_btn=Button(search_student_frame,text="Search",width=8,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        search_btn.grid(row=0,column=3,padx=4)

        showall_btn=Button(search_student_frame,text="Show All",width=8,font=("times new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
        showall_btn.grid(row=0,column=4,padx=4)
#table frame
        table_frame = Frame(right_frame,bd=2,bg="white")
        table_frame.place(x=10,y=150,width=880,height=330)
        ...
        self.student_table.column("dep",width=70)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="select Course" or self.var_year.get()=="select Year" or self.var_semester.get()=="select Semester" or self.var_id.get()=="" or self.var_dep.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_gender.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_name.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="Subhi@1503",database="face-recognizer")
...
#########delete function#########
    def delete_data(self):
        if self.var_id.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Student Delete Page","Do you want to delete this student from list?",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="Subhi@1503",database="face-recognizer")
                    my_cursor=conn.cursor()
